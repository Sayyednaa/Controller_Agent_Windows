"""
Django settings for Controller Agent server.
...
ALLOWED_HOSTS = [
    ...
    '*' # For testing, remove in strict production if domain is known
]
TIMEZONE='Asia/Kolkata'
DEFAULT_TIMEZONE='Asia/Kolkata'
USE_TZ=True
# Add your PythonAnywhere username here
...
# Database
# SQLite for development, can be changed for production
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'api.auth.DeviceTokenAuthentication',
    ],
...
# Cloudinary configuration (for metadata validation)
